      ...
      <div className="flex flex-col gap-12 my-10 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 text-sm text-gray-600 md:w-2/4">
          ...
          <p>
            ...
            and deliver superior service. Whether you&apos;re booking your first appointment or
            managing ongoing care, Prescripto is here to support you every step of the way.
          </p>
